...
int main() {
  ...
  switch(tipo){
    ...
    case 'P':
      for(int run=0; run<quantidade; run++){
				*img = abrir_imagem("data/cachorro.jpg");
		    printf("img->r(65,67) = %f\n", img->r[65*img->width+67]);
		    printf("img->g(65,67) = %f\n", img->g[65*img->width+67]);
		    printf("img->b(65,67) = %f\n", img->b[65*img->width+67]);
